...
class MenuLauncher: NSObject, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    let settings: [Setting] = {
        return [Setting(name: "My Account", imageName: "ic_account_circle"),
                Setting(name: "Transaction History", imageName: "ic_history"),
                Setting(name: "Contact Us", imageName: "ic_info_outline"),
                Setting(name: "Logout",imageName: "ic_exit_to_app")]
    }()
    
    var homeController: SchedulerViewController?
