//
//  OrderWashingViewController.swift
//  CleanSwipe0-1
//
...
class OrderWashingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.orderIdLabel.text = "\(username)'s Order"
    ...
    @IBAction func confirmWashing(_ sender: AnyObject) {
        
        //navigationController?.popViewControllerAnimated(true)
        
        let orderId = appointment.transactionId
        AppointmentManager.sharedManager.selectedAppointment = appointment
        AppointmentManager.sharedManager.updateOrderStatus(currentEmp.empId, order_id:orderId, newStatus: "washing")
        ...
        if isRegistered {
            ...
            manager.postPushForAppointmentUpdate(appointment.customerId, message: "CleanSwiper \(currentEmp.fullName) has begun washing your clothes. Stay tuned for delivery updates.", token: userToken)
        }else{
